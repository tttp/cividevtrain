...
<table class="form-layout-compressed">
  ...
  <tr>
    ...
    {* Erik Hommel, Developer Training Gent 27 and 28 March 2013 *}
    {* only show Nickname if current user in group NickErik *}
    {crmAPI var='result' entity='GroupContact' action='get' q='civicrm/ajax/rest' sequential=1 contact_id=$session->get('userID')}
    {foreach from=$result.values item=GroupContact}
        {if $GroupContact.title == "NickErik"}
            <td>
