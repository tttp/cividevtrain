  ...
  <div class="crm-actions-ribbon">
      <ul id="actions">
        ...
        {* Include the Actions and Edit buttons if user has 'edit' permission and contact is NOT in trash. *}
          ...
          {* Customization Erik Hommel - CiviCRM Developer Training Gent 27/28 March 2013 *}
          {* add default button *}
          <li>
              <a href="http://www.civicrm.org" class="info button" title="Dev Training">
              <span><div class="icon info-icon"></div>Dev Training</span></a>
          </li>
          {* end customization *}
